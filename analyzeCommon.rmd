...
londonbands
```
Ah, then.  It looks like a lot people are simply named London.  That's not cricket.  Let's limit ourselves to bands that start with  "London."  Not perfect but covers the vast number of false positives.
...
wordcloud(words = londonbands$artistToken,
          freq = londonbands$count*10,
          random.order=FALSE,
          rot.per=0.35,
