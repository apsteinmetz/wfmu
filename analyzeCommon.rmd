...
```{r}
# not looking for "LA" or "NYC"
cities=c('tokyo','dehli','shanghai','beijing','newyork','buenosares','saopaolo',"calcutta",'istanbul','rio','','manila','lagos','losangeles')
...
Boo ya!
```{r}
nybands<-artist_count%>%filter(str_detect(artistToken,"newyork"))%>%
  mutate(artistToken=str_replace(artistToken,"newyork","ny"))
