...
#trying to get bars in height order
#levels(artist_count$artistToken)<-artist_count$artistToken
gg<-ggplot(artist_count[1:10,],aes(x=artistToken,y=count/nrow(DJKey)*100))+geom_col()
gg<-gg+labs(title='Most Widely Played Artists on WFMU',
            y='Pct of DJs Who Have Played',
            x= 'Artist')
print(gg)
```
