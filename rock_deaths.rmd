...
There are some interesting causes in this list.  Three electrocutions, two by guitar and one my microphone. They all happened in England in the early 70s.  Presumably the codes have been tightned up a bit since.  Three people are listed who choked on their own vomit.  Boring.  Consider the hapless Steve Took of T Rex, who died from choking on a cocktail cherry.  That's why I always take my Manhattans with a lemon twist instead.
...
y='Rocker Music Deaths (1950-Present)',x='US Deaths (2015)')
gg
```
...
We've scientifically proven (!) that rock stars "live fast."  Do they die young?  Life expectancies have grown over the years so taking an aggregate average age at death won't be comprable to current US life expectancy.  To get a comparison let's pull the 
