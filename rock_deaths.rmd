...
gg<-gg+geom_col(aes(y=relative_mortality,fill="darkgrey"),color="darkgrey")
...
gg<-gg+ scale_fill_identity(name = 'Gap', guide = 'legend',labels = c('')) +
    scale_colour_manual(name = 'Life Exp.', 
         values =c('black'='black','red'='red'), labels = c('US Pop.',"Rockers"))
gg
```
This really surprised me.  Rock stars used to die young, but not any more!  They have completely closed the gap with the U.S. population at large.  Again, Keith Richards, stick with the yoga, dude!
