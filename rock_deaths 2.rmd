...
Now we have a clean list of cities and populations.  Let's merge it with our death locations to get a per-capita number. How did we do?
```{r}
temp<- deaths_loc%>% group_by(city) %>% 
