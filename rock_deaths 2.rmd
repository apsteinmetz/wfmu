...
Now we have a clean list of cities and populations.  Let's merge it with our death locations to get a per-capita number.

```{r}
deaths_loc %>% left_join(city_pop)

```
Not so good. There is a bit of work to be done to make sure the city names in this data set match up with the city names in our deaths data set.
```{r}
