...
#did a manual text replace of the html file to break the artist name and band names into two columns
# by replacing '<small>' with '</td><td>' and '</small>' with ''.
death_page<-read_html("death_page.html")
death_table_nodes<-death_page %>% html_nodes("table")
#wish I could just get the table but
...
#replace all footnotes with null
