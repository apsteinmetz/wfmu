...
#WORK HERE
deaths<-death_table_nodes[[length(death_table_nodes)-1]] %>% 
  html_table(fill=TRUE)
deaths<-deaths %>% bind_rows(death_table_nodes[[length(death_table_nodes)]] %>% html_table(fill=TRUE))


names(deaths)<-c("Name","Band","Age","Date","Location","Cause_of_Death")
deaths <-deaths %>% as_data_frame()
